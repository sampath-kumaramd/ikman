...
function AreaPill({ name }: { name: string }) {
  return (
    <span className="glass-subtle mx-1.5 inline-flex items-center gap-1.5 rounded-full px-3.5 py-1.5 text-sm text-zinc-300">
...
export function AreasMarquee() {
  return (
    <section id="coverage" className="relative py-20 lg:py-24">
      ...
      <Reveal delay={0.1}>
        <div className="relative mt-12 overflow-hidden">
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute inset-y-0 left-0 w-16 bg-gradient-to-r from-[#07090f] to-transparent sm:w-28"
          />
          <div
            aria-hidden
            className="pointer-events-none absolute inset-y-0 right-0 w-16 bg-gradient-to-l from-[#07090f] to-transparent sm:w-28"
          />
        </div>
      </Reveal>
    </section>
