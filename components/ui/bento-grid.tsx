...
const BentoCard = ({
  ...
  <div
    key={name}
    className={cn(
      "group relative col-span-3 flex transform-gpu flex-col justify-between overflow-hidden rounded-2xl",
      // macOS glass material (frosted fill + light-catching rim)
      "glass",
      className
    )}
    {...props}
  >
    ...
    <div className="pointer-events-none absolute inset-0 transform-gpu transition-all duration-300 group-hover:bg-white/[0.04]" />
  </div>
)
